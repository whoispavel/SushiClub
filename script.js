...
const languageData = {
    en: {
        ...
        'menu-item-2-desc': 'Futomaki with tuna (6 pieces)<br>Nigiri salmon (4 pieces)',
        'menu-item-2-price': 'Price: 72 zł',
        'menu-item-3-title': 'Set 3',
        'menu-item-3-desc': 'Uramaki California (8 pieces)<br>Hosomaki with avocado (6 pieces)',
        'menu-item-3-price': 'Price: 58 zł',
        'menu-item-4-title': 'Set 4',
        'menu-item-4-desc': 'Futomaki dragon (6 pieces)<br>Nigiri with shrimp (4 pieces)',
        'menu-item-4-price': 'Price: 78 zł',
    ...
    pl: {
        ...
        'menu-item-2-desc': 'Futomaki z tuńczykiem (6 sztuk)<br>Nigiri łosoś (4 sztuki)',
        'menu-item-2-price': 'Cena: 72 zł',
        'menu-item-3-title': 'Zestaw 3',
        'menu-item-3-desc': 'Uramaki Kalifornia (8 sztuk)<br>Hosomaki z awokado (6 sztuk)',
        'menu-item-3-price': 'Cena: 58 zł',
        'menu-item-4-title': 'Zestaw 4',
        'menu-item-4-desc': 'Futomaki smok (6 sztuk)<br>Nigiri z krewetkami (4 sztuki)',
        'menu-item-4-price': 'Cena: 78 zł',
