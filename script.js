...
const languageData = {
    en: {
        ...
        'menu-item-1-desc': '·Futomak grilled salmon (6 szt.) — nori, ryż, grilled salmon, Philadelphia cheese, cucumber, kanpyo<br>·Hosomaki grilled salmon (8 szt.) — nori, ryż, grilled salmon, Philadelphia cheese',
        'menu-item-1-subtitle': '(14 szt. + 6 szt. GRATIS)',
        'menu-item-1-price': 'Price: 67 zł',
        'menu-item-2-title': 'Set 2',
        'menu-item-2-desc': '·Futomak raw salmon (6 szt.) — nori, ryż, Philadelphia cheese, salmon, avocado, cucumber<br>·Hosomaki raw salmon (8 szt.) — nori, ryż, salmon, Philadelphia cheese<br>·1 free roll (6 szt.)',
        'menu-item-2-subtitle': '(14 szt. + 6 szt. GRATIS)',
        'menu-item-2-price': 'Price: 67 zł',
        'menu-item-3-title': 'Set 3',
        'menu-item-3-desc': '·California tuna in mango — nori, ryż, Philadelphia cheese, tuna, sriracha, cucumber, mango<br>·Futomak grilled salmon — nori, ryż, grilled salmon, Philadelphia cheese, cucumber, kanpyo<br>·Hosomaki cucumber — nori, ryż, Philadelphia cheese, cucumber',
        'menu-item-3-subtitle': '(26 szt. + 6 szt. GRATIS)',
        'menu-item-3-price': 'Price: 137 zł',
        'menu-item-4-title': 'Set 4',
        'menu-item-4-desc': '·Philadelphia mango with salmon — nori, ryż, Philadelphia cheese, mango, grilled salmon, unagi sauce<br>·California shrimp — nori, ryż, mayonnaise sauce, shrimp tempura, cucumber, salmon tartar, sesame oil<br>·Futomak tilapia — nori, ryż, tilapia tempura, mayonnaise sauce, cucumber<br>·Hosomaki cucumber — nori, ryż, Philadelphia cheese, cucumber<br>·Hosomaki sweet potato — nori, ryż, Philadelphia cheese, sweet potato',
        'menu-item-4-subtitle': '(46 szt. + 6 szt. GRATIS)',
        'menu-item-4-price': 'Price: 197 zł',
        'menu-item-5-title': 'Set 5',
        'menu-item-5-desc': '·California eel — nori, ryż, green masago, Philadelphia cheese, eel, cucumber<br>·Futomaki surimi — nori, ryż, Philadelphia cheese, mayonnaise, leek, surimi, togarashi, tempura<br>·Futomaki shrimp — nori, ryż, mayonnaise, shrimp<br>·Hosomaki mango — nori, ryż, Philadelphia cheese, mango<br>·Hosomaki avocado — nori, ryż, Philadelphia cheese, avocado<br>·Hosomaki salmon — nori, ryż, Philadelphia cheese, salmon',
        'menu-item-5-subtitle': '(46 szt. + 6 szt. GRATIS)',
        'menu-item-5-price': 'Price: 205 zł',
        'menu-item-6-title': 'Set 6',
        'menu-item-6-desc': '·Vulkan grilled salmon — nori, ryż, Philadelphia cheese, grilled salmon, sweet sauce<br>·Vulkan salmon tartar — nori, ryż, salmon tartar, leek, togarashi, sesame oil<br>·Vulkan crab — nori, ryż, Philadelphia cheese, cooked shrimp, masago, sweet sauce<br>·Nigiri salmon — ryż, salmon<br>·Nigiri tuna — ryż, tuna, sriracha<br>·Nigiri eel — ryż, eel',
        'menu-item-6-subtitle': '(12 szt. + 6 szt. GRATIS)',
        'menu-item-6-price': 'Price: 127 zł',
        'menu-item-7-title': 'Futo Set',
        'menu-item-7-desc': 'Futomaki salmon tartar, salmon, surimi salad, shrimp, tuna, vegetarian (12 szt. each)',
        'menu-item-7-subtitle': '(72 szt. + 6 szt. GRATIS)',
        'menu-item-7-price': 'Price: 395 zł',
        'menu-item-8-title': 'California Set',
        'menu-item-8-desc': '6 rolls of 10 szt. — grilled salmon + mango, salmon, tuna + masago, sweet potato + pear, zucchini + bacon, eel',
        'menu-item-8-subtitle': '(70 szt. + 6 szt. GRATIS)',
        'menu-item-8-price': 'Price: 377 zł',
        'menu-item-9-title': 'Vegetarian Set',
        'menu-item-9-desc': '6 rolls: tofu, zucchini + cucumber, cucumber + goma, kampyo, mango, nigiri avocado',
        'menu-item-9-subtitle': '(50 szt. + 6 szt. GRATIS)',
        'menu-item-10-title': 'Hosomaki Set',
        'menu-item-10-desc': '10 types of hosomaki — cucumber, kampyo, mango, avocado, sweet potato, salmon, tuna (with sriracha), grilled salmon, shrimp, eel',
        'menu-item-10-subtitle': '(80 szt. + 6 szt. GRATIS)',
    ...
    pl: {
        ...
        'menu-item-1-desc': '·Futomak pieczony łosoś (6 szt.) — nori, ryż, łosoś pieczony, serek Philadelphia, ogórek, kanpyo<br>·Hosomaki pieczony łosoś (8 szt.) — nori, ryż, pieczony łosoś, serek Philadelphia',
        'menu-item-1-subtitle': '(14 szt. + 6 szt. GRATIS)',
        ...
        'menu-item-4-desc': '·Philadelphia mango z łososiem — nori, ryż, serek Philadelphia, mango, łosoś opalany, sos unagi<br>·California krewetka — nori, ryż, sos majonez, krewetka tempura, ogórek, tatar z łososia, olej sezamowy<br>·Futomak tilapia — nori, ryż, tilapia tempura, sos majonez, ogórek<br>·Hosomaki ogórek — nori, ryż, serek Philadelphia, ogórek<br>·Hosomaki batat — nori, ryż, serek Philadelphia, batat',
        'menu-item-4-subtitle': '(46 szt. + 6 szt. GRATIS)',
        'menu-item-4-price': 'Cena: 197 zł',
        'menu-item-5-title': 'Zestaw 5',
        'menu-item-5-desc': '·California węgorz — nori, ryż, zielone masago, serek Philadelphia, węgorz, ogórek<br>·Futomaki surimi — nori, ryż, serek Philadelphia, majonez, por, surimi, togarashi, tempura<br>·Futomaki krewetka — nori, ryż, majonez, krewetka<br>·Hosomaki mango — nori, ryż, serek Philadelphia, mango<br>·Hosomaki awokado — nori, ryż, serek Philadelphia, awokado<br>·Hosomaki łosoś — nori, ryż, serek Philadelphia, łosoś',
        'menu-item-5-subtitle': '(46 szt. + 6 szt. GRATIS)',
        'menu-item-5-price': 'Cena: 205 zł',
        'menu-item-6-title': 'Zestaw 6',
        'menu-item-6-desc': '·Vulkan łosoś pieczony — nori, ryż, serek Philadelphia, łosoś pieczony, sos słodki<br>·Vulkan tatar z łososia — nori, ryż, tatar z łososia, por, togarashi, olej sezamowy<br>·Vulkan krabowy — nori, ryż, serek Philadelphia, krewetka gotowana, masago, sos słodki<br>·Nigiri łosoś — ryż, łosoś<br>·Nigiri tuńczyk — ryż, tuńczyk, sriracha<br>·Nigiri węgorz — ryż, węgorz',
        'menu-item-6-subtitle': '(12 szt. + 6 szt. GRATIS)',
        'menu-item-6-price': 'Cena: 127 zł',
        'menu-item-7-title': 'Futo Set',
        'menu-item-7-desc': 'Futomaki tatar z łososia, łosoś, sałatka surimi, krewetka, tuńczyk, wegetariański (po 12 szt.)',
        'menu-item-7-subtitle': '(72 szt. + 6 szt. GRATIS)',
        'menu-item-7-price': 'Cena: 395 zł',
        'menu-item-8-title': 'California Set',
        'menu-item-8-desc': '6 rolek po 10 szt. — pieczony łosoś + mango, łosoś, tuńczyk + masago, batat + gruszka, cukinia + boczek, węgorz',
        'menu-item-8-subtitle': '(70 szt. + 6 szt. GRATIS)',
        'menu-item-8-price': 'Cena: 377 zł',
        'menu-item-9-title': 'Wegetariański Set',
        'menu-item-9-desc': '6 rolek: tofu, cukinia + ogórek, ogórek + goma, kampyo, mango, nigiri awokado',
        'menu-item-9-subtitle': '(50 szt. + 6 szt. GRATIS)',
        'menu-item-9-price': 'Cena: 167 zł',
        'menu-item-10-title': 'Hosomaki Set',
        'menu-item-10-desc': '10 rodzajów hosomaki — ogórek, kampyo, mango, awokado, batat, łosoś, tuńczyk (z sriracha), łosoś pieczony, krewetka, węgorz',
        'menu-item-10-subtitle': '(80 szt. + 6 szt. GRATIS)',
